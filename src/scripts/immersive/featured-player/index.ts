...
import { getReducedMotionQuery } from '../../a11y-utils'
...
import type { FeaturedRecording, TrackCycleDirection, FeaturedImageTransitionTarget } from './types'
import {
  formatTime,
  asMetaText,
...
export function initFeaturedPlayer(): () => void {
  ...
  const prefersReducedMotion = getReducedMotionQuery()!
